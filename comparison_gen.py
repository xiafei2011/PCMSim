...
commit of PCMSim2
( see: https://github.com/dramninjasUMD/PCMSim2/commit/e46f525bd274a0b3312002dce3efe83c769ea2ce )
...
binaries = ['PCMSim.master', 'PCMSim.cleanup']

pcmsim_flags = '-c 2000000 -n -S 8192 -q '
	...
	for device in devices:
		for paramOverrides in paramOverrideList:
			for executable in binaries:
				...
				print "./%s -s system.ini -d ini/%s -t traces/%s -o %s %s -v %s &"%(executable, device, trace, paramOverrides, pcmsim_flags, output_file)
			i+=1
